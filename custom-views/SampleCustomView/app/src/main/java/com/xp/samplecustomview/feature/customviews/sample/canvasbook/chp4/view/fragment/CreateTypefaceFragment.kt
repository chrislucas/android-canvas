...
class CreateTypefaceFragment : Fragment(), BaseBehaviorFragment {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_create_typeface, container, false)
    }

    companion object {
        @JvmStatic
        fun newInstance() = CreateTypefaceFragment()
    }
