 ...
 */
class SlideCustomBezierCurveViewsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SlideCustomBezierCurveViewsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SlideCustomBezierCurveViewsFragment().apply {
