package com.xp.samplecustomview.feature.recyclerview.features.hierarchical.feature.composite.view.fragments
...
class TwoListDepartmentsBottomSheetDialogFragment : Fragment(), BaseBehaviorFragment {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = TwoListDepartmentsBottomSheetDialogFragment()
    }
