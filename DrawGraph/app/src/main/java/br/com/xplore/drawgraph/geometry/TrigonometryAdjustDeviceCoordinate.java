...
public class TrigonometryAdjustDeviceCoordinate {
    ...
    public static double circularAngleRadBetweenPoints(double cx1, double cy1, double px2, double py2) {
        /**
         ...
         * o intervalor da funcao eh [-PI, -PI/2]
         * para x > 0 e y < 0
         * o intervalor da funcao eh [-PI/2, PI]
         * */
        return PI - atan2(-(py2-cy1), -(px2-cx1)) % (PI * 2);
    }

    public static double circularAngleDegBetweenPoints(double cx1, double cy1, double px2, double py2) {
        /**
         ...
         *
         * */
        //double angle = atan2(py2-cy1, px2-cx1) * 180.0f / PI;
        /**
         * Um teste para coordenadas de dispositivo
         * se py2-cy1 < 0 o ponto escolhido esta acima do ponto
